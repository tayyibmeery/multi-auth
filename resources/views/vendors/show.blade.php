...
@section("content")
				<div class="space-y-6">
																				...
																				<div>
																								...
																								<div class="h-2 w-full rounded-full bg-gray-200">
																												<div class="h-2 rounded-full bg-green-600"
																																style="width: {{ min(($vendor->purchases_count / max($vendor->purchases_count, 1)) * 100, 100) }}%">
																												</div>
																								</div>
																				</div>
								...
								<div class="rounded-lg bg-white p-6 shadow">
												...
												@if ($vendor->purchases->count() > 0)
																				...
																				<table class="min-w-full divide-y divide-gray-200">
																								<thead class="bg-gray-50">
																												<tr>
																																...
																																<th class="px-4 py-3 text-left text-xs font-medium uppercase text-gray-500">Items Count</th>
																...
																<div class="mt-4 text-center">
																				<a href="{{ route("purchases.index") }}?vendor_id={{ $vendor->id }}"
								...
								@if ($vendor->purchases->count() > 0)
												<div class="rounded-lg bg-white p-6 shadow">
																<h3 class="mb-4 text-lg font-semibold text-gray-900">Frequently Purchased Items</h3>
																@php
