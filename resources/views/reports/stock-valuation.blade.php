				...
				<div class="space-y-6">
												...
												<div class="overflow-x-auto">
																<table class="min-w-full divide-y divide-gray-200">
																				...
																				<tfoot class="bg-gray-50">
																								<tr>
																												<td colspan="4" class="px-4 py-3 text-right text-sm font-medium text-gray-900">Total Items
																																Value:</td>
								...
								<div class="rounded-lg bg-white p-6 shadow">
												...
												<div class="grid grid-cols-1 gap-6 md:grid-cols-2">
																								...
																								<div>
																												...
																												<div class="h-2 w-full rounded-full bg-gray-200">
																																<div class="h-2 rounded-full bg-blue-600"
																																				style="width: {{ $totalItemValue + $totalProductValue > 0 ? ($totalItemValue / ($totalItemValue + $totalProductValue)) * 100 : 0 }}%">
																																</div>
																												</div>
																								</div>
																								<div>
																												...
																												<div class="h-2 w-full rounded-full bg-gray-200">
																																<div class="h-2 rounded-full bg-green-600"
																																				style="width: {{ $totalItemValue + $totalProductValue > 0 ? ($totalProductValue / ($totalItemValue + $totalProductValue)) * 100 : 0 }}%">
																																</div>
																												</div>
																								</div>
																				</div>
																...
																<!-- Top 5 Most Valuable -->
																<div>
																				<h3 class="mb-3 text-lg font-medium text-gray-900">Top 5 Most Valuable Items</h3>
																				<div class="space-y-2">
