        ...
        <form action="{{ route("purchases.store") }}" method="POST" class="p-6" id="purchaseForm">
            ...
            <div class="mb-6 grid grid-cols-1 gap-6 md:grid-cols-2">
                <div>
                    ...
                    <select name="vendor_id" id="vendor_id" required class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-blue-500">
                ...
                <div>
                    ...
                    <input type="date" name="purchase_date" id="purchase_date" required class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-blue-500" value="{{ old("purchase_date", date("Y-m-d")) }}">
                    @error("purchase_date")
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="mb-6">
                <div class="mb-4 flex items-center justify-between">
                    <h3 class="text-lg font-medium text-gray-900">Purchase Spare Parts </h3>

                    <button type="button" id="addItem" class="rounded-lg bg-green-600 px-3 py-2 text-sm text-white hover:bg-green-700">
                ...
                <div id="items-container">
                    ...
                    <div class="item-row mb-4 grid grid-cols-12 items-end gap-4">
                        ...
                        <div class="col-span-2">
                            ...
                            <input type="number" name="items[0][quantity]" required min="1" class="quantity-input mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-blue-500">
                        </div>
                        <div class="col-span-2">
                            <label class="block text-sm font-medium text-gray-700">Unit Price (Rs ) *</label>
                            <input type="number" name="items[0][unit_price]" required step="0.01" min="0" class="price-input mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-blue-500">
                        </div>
                        <div class="col-span-2">
                            <label class="block text-sm font-medium text-gray-700">Total (Rs )</label>
                            <input type="text" readonly class="total-input mt-1 block w-full rounded-md border border-gray-300 bg-gray-100 px-3 py-2 shadow-sm">
                        </div>
                        <div class="col-span-1">
                            <button type="button" class="remove-item rounded-lg bg-red-600 p-2 text-white hover:bg-red-700">
            ...
            <div class="flex justify-end space-x-3">
                <a href="{{ route("purchases.index") }}" class="rounded-lg bg-gray-300 px-4 py-2 font-medium text-gray-800 hover:bg-gray-400">
                    Cancel
                </a>
