...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        ...
        <div class="flex space-x-3">
            <a href="{{ route("purchases.index") }}" class="rounded-lg bg-gray-600 px-4 py-2 font-medium text-white hover:bg-gray-700">
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div class="rounded-lg bg-white p-6 shadow lg:col-span-2">
            <h3 class="mb-4 text-lg font-semibold text-gray-900">Purchase Spare Parts </h3>
