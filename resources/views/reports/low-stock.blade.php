																...
																<div class="rounded-lg border border-red-200 bg-red-50 p-6">
																				<div class="mb-4 flex items-center">
																								...
																								<div class="ml-3">
																												...
																												<p class="text-red-700">These items are completely out of stock and need immediate attention.
																												</p>
																								</div>
																				...
																				<div class="overflow-x-auto">
																								<table class="min-w-full divide-y divide-red-200">
																												<thead class="bg-red-100">
																																<tr>
																																				<th class="px-4 py-3 text-left text-xs font-medium uppercase text-red-800">Item</th>
																...
																<div class="rounded-lg border border-yellow-200 bg-yellow-50 p-6">
																				<div class="mb-4 flex items-center">
																								...
																								<div class="ml-3">
																												...
																												<p class="text-yellow-700">These items are below minimum stock levels and should be reordered
																																soon.</p>
																								</div>
																				...
																				<div class="overflow-x-auto">
																								<table class="min-w-full divide-y divide-yellow-200">
																												<thead class="bg-yellow-100">
																																<tr>
																																				<th class="px-4 py-3 text-left text-xs font-medium uppercase text-yellow-800">Item</th>
												...
												<div class="rounded-lg bg-white p-6 shadow">
																...
																<div class="grid grid-cols-1 gap-4 md:grid-cols-2">
																				<div class="rounded-lg border border-gray-200 p-4">
																								...
																								<p class="mb-3 text-sm text-gray-600">Create a purchase order for all low stock items</p>
								...
								@else
												...
												<div class="rounded-lg bg-white p-8 text-center shadow">
																<div class="flex flex-col items-center justify-center">
																				...
																				<h3 class="mb-2 text-2xl font-bold text-gray-900">All Items Are Sufficiently Stocked!</h3>
																				<p class="mb-6 text-gray-600">Great job! No items are currently below minimum stock levels.</p>
																				<div class="flex space-x-3">
																								<a href="{{ route("reports.stock") }}"
																												class="rounded-lg bg-blue-600 px-4 py-2 font-medium text-white hover:bg-blue-700">
																												View Stock Report
