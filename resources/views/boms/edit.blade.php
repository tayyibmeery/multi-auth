												...
												<form action="{{ route("boms.update", $bom) }}" method="POST" class="p-6" id="bomForm">
																...
																<div class="mb-6">
																				...
																				<textarea name="description" id="description" rows="3"
																				    class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-blue-500">{{ old("description", $bom->description) }}</textarea>
																</div>
																												...
																												<div class="bom-item-row mb-4 grid grid-cols-12 items-end gap-4">
																																...
																																<div class="col-span-2">
																																				...
																																				<input type="text" readonly
																																								...
																																								value="Rs {{ number_format($bomItem->quantity * $bomItem->item->current_price, 2) }}">
																																</div>
