												...
												<form action="{{ route("items.update", $item) }}" method="POST" class="p-6">
																...
																<div class="mt-6">
																				...
																				<textarea name="description" id="description" rows="3"
																				    class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-blue-500">{{ old("description", $item->description) }}</textarea>
																</div>
