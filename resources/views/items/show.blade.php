				...
				<div class="space-y-6">
								...
								<div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
												...
												<div class="rounded-lg bg-white p-6 shadow">
																<h3 class="mb-4 text-lg font-semibold text-gray-900">Item Information</h3>
																<dl class="space-y-3">
																				<div>
												...
												<div class="rounded-lg bg-white p-6 shadow">
																...
																<dl class="space-y-3">
																				<div>
																								...
																								<dd
																												class="{{ $item->current_stock == 0 ? "text-red-600" : ($item->is_low_stock ? "text-yellow-600" : "text-green-600") }} text-2xl font-bold">
