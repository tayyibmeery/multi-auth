...
<div class="space-y-6">
    <div class="flex justify-between items-center">
        ...
        <div class="flex space-x-3">
            ...
            <a href="{{ route('reports.purchases') }}" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg font-medium">
                    ...
                    @forelse($productionRuns as $run)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                ₹{{ number_format($run->total_production_cost, 2) }}
                            </td>
                        </tr>
                    @empty
                        <tr>
    ...
    @if($productionRuns->count() > 0)
        <div class="bg-white shadow rounded-lg p-6">
            <h3 class="text-lg font-semibold text-gray-900 mb-4">Product Production Summary</h3>
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Product</th>
                            <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Production Runs</th>
                            <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Total Produced</th>
                            <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Avg per Run</th>
