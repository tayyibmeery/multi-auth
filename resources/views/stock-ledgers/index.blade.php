    ...
    <div class="rounded-lg bg-white p-4 shadow">
        <form method="GET" action="{{ route("stock-ledgers.index") }}" class="grid grid-cols-1 gap-4 md:grid-cols-4">
            <div>
                ...
                <select name="type" id="type" class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-blue-500">
            ...
            <div>
                <label for="item_id" class="block text-sm font-medium text-gray-700">Spare Part</label>

                <select name="item_id" id="item_id" class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-blue-500">
                    <option value="">All Spare Part</option>
            ...
            <div class="flex justify-end space-x-3 md:col-span-4">
                <a href="{{ route("stock-ledgers.index") }}" class="rounded-lg bg-gray-300 px-4 py-2 font-medium text-gray-800 hover:bg-gray-400">
                    Clear Filters
                </a>
