                    ...
                    <form action="{{ route('vendors.update', $vendor) }}" method="POST" id="vendorForm">
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control @error('name') is-invalid @enderror rounded-right" id="name" name="name" placeholder="Enter vendor name" value="{{ old('name', $vendor->name) }}" required>
                                        </div>
                                        @error('name')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control @error('contact_person') is-invalid @enderror rounded-right" id="contact_person" name="contact_person" placeholder="Enter contact person name" value="{{ old('contact_person', $vendor->contact_person) }}">
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="email" class="form-control @error('email') is-invalid @enderror rounded-right" id="email" name="email" placeholder="Enter email address" value="{{ old('email', $vendor->email) }}">
                                        </div>
                                        @error('email')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control @error('phone') is-invalid @enderror rounded-right" id="phone" name="phone" placeholder="Enter phone number" value="{{ old('phone', $vendor->phone) }}">
                                        </div>
                                        @error('phone')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                        @enderror
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('address') is-invalid @enderror" id="address" name="address" rows="3" placeholder="Enter complete vendor address">{{ old('address', $vendor->address) }}</textarea>
                                @error('address')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2bs4 @error('vendor_type') is-invalid @enderror" name="vendor_type" style="width: 100%;">
                                            ...
                                            <option value="wholesaler" {{ old('vendor_type', $vendor->vendor_type) == 'wholesaler' ? 'selected' : '' }}>Wholesaler</option>
                                        </select>
                                        @error('vendor_type')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2bs4 @error('payment_terms') is-invalid @enderror" name="payment_terms" style="width: 100%;">
                                            ...
                                            <option value="net_45" {{ old('payment_terms', $vendor->payment_terms) == 'net_45' ? 'selected' : '' }}>Net 45 Days</option>
                            ...
                            <div class="form-group mb-0">
                                <div class="custom-control custom-switch custom-switch-lg">
                                    <input type="checkbox" class="custom-control-input" id="status" name="status" value="1" {{ old('status', $vendor->status) ? 'checked' : '' }}>
