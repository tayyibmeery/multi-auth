        ...
        <form action="{{ route("boms.store") }}" method="POST" class="p-6" id="bomForm">
            ...
            <div class="mb-6 grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="text" name="name" id="name" required class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-blue-500" value="{{ old("name") }}">
                    @error("name")
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="mb-6">
                ...
                <textarea name="description" id="description" rows="3" class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-blue-500">{{ old("description") }}</textarea>
            </div>
                ...
                <div id="bom-items-container">
                    ...
                    <div class="bom-item-row mb-4 grid grid-cols-12 items-end gap-4">
                        <div class="col-span-6">
                            <label class="block text-sm font-medium text-gray-700">Spare Part*</label>

                            <select name="items[0][item_id]" required class="item-select mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-blue-500">
                        ...
                        <div class="col-span-3">
                            ...
                            <input type="number" name="items[0][quantity]" required min="1" step="0.001" class="quantity-input mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-blue-500">
                        </div>
                        <div class="col-span-2">
                            <label class="block text-sm font-medium text-gray-700">Estimated Cost</label>
                            <input type="text" readonly class="cost-input mt-1 block w-full rounded-md border border-gray-300 bg-gray-100 px-3 py-2 shadow-sm">
                        </div>
            ...
            <div class="mb-6 flex items-center">
                <input type="checkbox" name="is_active" id="is_active" value="1" checked class="h-4 w-4 rounded border-gray-300 text-blue-600 focus:ring-blue-500">
            ...
            <div class="flex justify-end space-x-3">
                <a href="{{ route("boms.index") }}" class="rounded-lg bg-gray-300 px-4 py-2 font-medium text-gray-800 hover:bg-gray-400">
                    Cancel
                </a>
