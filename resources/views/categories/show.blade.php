																...
																<div class="space-y-4">
																				...
																				<div>
																								<div class="mb-1 flex items-center justify-between">
																												...
																												<span
																																class="@if ($category->items->where("current_stock", 0)->count() > 0) text-red-600
								...
								<div class="rounded-lg bg-white p-6 shadow">
												...
												@else
																<div class="py-8 text-center">
																				...
																				<p class="mb-2 text-lg text-gray-500">No items in this category yet</p>
																				<p class="mb-4 text-sm text-gray-400">Start by adding items to this category</p>
																				<a href="{{ route("items.create") }}?category_id={{ $category->id }}"
