																...
																<table class="min-w-full divide-y divide-gray-200">
																				<thead class="bg-gray-50">
																								<tr>
																												...
																												<th class="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-500">Items
																																Count</th>
																																...
																																<td class="whitespace-nowrap px-6 py-4 text-right text-sm font-medium">
																																				...
																																				@if (auth()->user()->isAdmin())
																																								<form action="{{ route("purchases.destroy", $purchase) }}" method="POST"
																																												class="inline"
																																												onsubmit="return confirmDelete('Are you sure you want to delete this purchase? This action cannot be undone.')">
																																												@csrf
																																												@method("DELETE")
																								...
																								@empty
																												<tr>
																																<td colspan="7" class="px-6 py-4 text-center text-sm text-gray-500">
																																				No purchases found. <a href="{{ route("purchases.create") }}"
																																								class="text-blue-600 hover:text-blue-500">Create the first purchase</a>.
																																</td>
																												</tr>
																								@endforelse
																				</tbody>
																												...
																												<div class="mx-4 flex-1">
																																<div class="h-3 w-full rounded-full bg-gray-200">
																																				<div class="h-3 rounded-full bg-blue-600"
																																								style="width: {{ min(($data->total / ($monthlyData->max("total") ?: 1)) * 100, 100) }}%">
																																				</div>
																																</div>
																												</div>
