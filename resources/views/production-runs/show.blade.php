...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        ...
        <div class="flex space-x-3">
            <a href="{{ route("production-runs.index") }}" class="rounded-lg bg-gray-600 px-4 py-2 font-medium text-white hover:bg-gray-700">
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div class="rounded-lg bg-white p-6 shadow">
            ...
            <dl class="space-y-3">
                ...
                <div>
                    ...
                    <dd class="{{ $productionRun->actual_quantity ? "text-green-600" : "text-gray-600" }} text-sm font-semibold">
        ...
        <div class="rounded-lg bg-white p-6 shadow">
            ...
            <div class="space-y-3">
                <a href="{{ route("boms.show", $productionRun->billOfMaterial) }}" class="block w-full rounded-lg bg-purple-600 px-4 py-2 text-center text-white hover:bg-purple-700">
                    <i class="fas fa-list-alt mr-2"></i>View Bill of Materials Details
                </a>
                <a href="{{ route("products.show", $productionRun->billOfMaterial->product) }}" class="block w-full rounded-lg bg-blue-600 px-4 py-2 text-center text-white hover:bg-blue-700">
                    <i class="fas fa-cube mr-2"></i>View Product
                </a>
                <a href="{{ route("stock-ledgers.index") }}?reference_id={{ $productionRun->id }}&reference_type=production_run" class="block w-full rounded-lg bg-green-600 px-4 py-2 text-center text-white hover:bg-green-700">
