...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        ...
        <a href="{{ route("vendors.create") }}" class="rounded-lg bg-blue-600 px-4 py-2 font-medium text-white hover:bg-blue-700">
                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="whitespace-nowrap px-6 py-4 text-right text-sm font-medium">
                            <a href="{{ route("vendors.show", $vendor) }}" class="mr-3 text-blue-600 hover:text-blue-900">
                                <i class="fas fa-eye"></i>
                            </a>
                            <a href="{{ route("vendors.edit", $vendor) }}" class="mr-3 text-green-600 hover:text-green-900">
