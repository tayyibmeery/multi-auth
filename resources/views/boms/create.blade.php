        ...
        <form action="{{ route('boms.store') }}" method="POST" class="p-6" id="bomForm">
            ...
            <div class="bg-gray-50 p-4 rounded-lg mb-6">
                <div class="flex justify-between items-center">
                    ...
                    <span id="totalEstimatedCost" class="text-2xl font-bold text-blue-600">₹0.00</span>
                </div>
            </div>
            ...
            <div class="flex justify-end space-x-3">
                <a href="{{ route('boms.index') }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 px-4 py-2 rounded-lg font-medium">
                    Cancel
                </a>
